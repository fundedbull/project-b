  ...
  return (
    <footer className="container mx-auto mt-10">
        ...
        <div className="mb-16 md:mb-0">
          ...
          <div className="flex flex-row gap-4 text-center font-icons text-sm text-white">
            ...
            <a
              ...
              className="bg-icons flex h-10 w-10 items-center justify-center rounded-lg"
            >
              <Image className="self-center" width="22" height="22" src={instagram_logo} alt="Instagram Logo" />
            </a>
            {/* <a
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              ...
              className="bg-icons flex h-10 w-10 items-center justify-center rounded-lg"
            >
              <Image className="self-center" width="24" height="24" src={linkedin_logo} alt="LinkedIn Logo" />
            </a>
            <a
              target="_blank"
              rel="noopener noreferrer"
              ...
              className="bg-icons flex h-10 w-10 items-center justify-center rounded-lg"
            >
              <Image className="self-center" width="24" height="24" src={youtube_logo} alt="Youtube Logo" />
            </a>
            ...
            <a
              ...
              className="bg-icons flex h-10 w-10 items-center justify-center rounded-lg"
            >
              <Image className="self-center" width="24" height="24" src={reddit_logo} alt="Reddit Logo" />
            </a>
            {/* <a
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className="ml-4 flex flex-col items-center justify-between py-8 md:ml-0 md:flex-row">
        <a href="/">
          <Image className="self-center" width="64" height="64" src={brix_logo} alt="BRIX Logo" />
        </a>
