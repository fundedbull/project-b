  ...
  return (
    ...
    >
      <video
        ...
        muted
        playsInline
        className="absolute top-0 left-0 w-full h-full max-h-[60vh] md:max-h-[90vh] object-contain md:object-cover -z-10"
      >
      ...
      <div className="relative z-10 flex flex-col h-full container mx-auto min-h-[60vh] md:min-h-[90vh]">
        ...
        <div className="flex flex-col items-start px-4 mt-10 md:mt-20">
          ...
          <Link
            href="/waitlist"
            className="relative p-1 w-64 text-center before:absolute before:inset-0 before:-z-10 before:bg-linear-to-r before:from-primary-400 before:to-green-400 before:rounded-full before:blur-sm"
          >
            <h1
      ...
      <div className="relative grid grid-rows-2 grid-cols-2 gap-8 w-fit h-full container mx-auto mt-40">
        <Image
        ...
        <Image
          ...
          height={720}
        />
        <div className="absolute top-1/4 right-1/4  animate-[spin_30s_linear_infinite] -z-10">
        ...
        <div className="absolute bottom-1/3 left-1/4  animate-[spin_30s_linear_infinite] -z-10">
          <div className="absolute -z-10 size-72 -translate-x-16 -translate-y-8 rounded-full bg-primary-400 blur-3xl"></div>
      ...
      <div className="flex flex-col items-center px-4  bg-[#0a0a14]">
      ...
      <div className="flex flex-col items-center justify-center w-full container mx-auto gap-8">
        ...
        <p className="text-2xl mt-4 text-center text-zinc-300">
          {
        ...
        <div className="flex gap-2">
          ...
          <div className="flex flex-col items-center gap-8">
            <Image
              ...
              height={420}
            />
            <p className="text-2xl font-medium line-clamp-2 text-center">
      ...
      <div className="flex flex-col items-center justify-center w-full container mx-auto gap-8 mt-20">
        ...
        <div className="flex gap-4">
          <div className="flex rounded-[2rem] bg-[#1d1a26] text-white p-7 w-1/3">
            <div>
              <Image
          ...
          <div className="rounded-[2rem] bg-[#1d1a26] text-white p-7 w-1/3">
            <div>
              <Image
                className="h-[60px] w-[60px] rounded-[16px]"
